    ...
    public class VetsDB : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Veterinarios>().HasData(
               new Veterinarios { ID = 1, Nome = "Maria Pinto", NumCedulaProf = "vet-345891", Foto = "Maria.jpg" },
               new Veterinarios { ID = 2, Nome = "Ricardo Ribeiro", NumCedulaProf = "vet-345901", Foto = "Ricardo.jpg" },
               new Veterinarios { ID = 3, Nome = "José Soares", NumCedulaProf = "vet-567321", Foto = "Jose.jpg" }
               );
